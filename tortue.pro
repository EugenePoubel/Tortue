...
QT += widgets 
# Input
HEADERS += parser/scanner.hh parser/driver.hh GUI/tortue.hh GUI/jardinHandler.hh GUI/jardinRendering.hh GUI/jardin.hh parser/condition.hh parser/instruction.hh
#LEXSOURCES += parser/scanner.ll
#YACCSOURCES += parser/parser.yy
SOURCES += parser/main.cc parser/driver.cc GUI/tortue.cc GUI/jardinHandler.cc GUI/jardinRendering.cc GUI/jardin.cc  parser/condition.cc parser/instruction.cc
